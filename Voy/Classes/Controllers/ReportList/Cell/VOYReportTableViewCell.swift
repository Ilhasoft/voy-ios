...
class VOYReportTableViewCell: UITableViewCell {
    ...
    func installShadow(view:UIView) {
        let radius: CGFloat = (self.contentView.frame.size.width - 60) / 2.0 //change it to .height if you need spread for height
        ...
        view.layer.shadowRadius = 3.0 //Here your control your blur
